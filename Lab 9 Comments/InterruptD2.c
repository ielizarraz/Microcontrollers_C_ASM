...
void Do_init()
{
     ...
     SSPCON1=0x20;                                      // SSPEN:
     for(I = 0; I < 50; I++)                            // Go through all variables in the array
     {
        angle = (2 * 3.141529 * I)/50.0;                // Set each one equal to a new angle value
        Array[I] = (int)(((sin(angle)+1)*2.5)*51);      // Get the integer of the sin of each new angle and put it into the array
