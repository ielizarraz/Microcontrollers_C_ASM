...
char array1[8] = {0x04, 0x01, 0x05, 0x06, 0x07, 0x02, 0x03, 0x00};  // hexadecimal array that contains the color values for D1 starting with blue and ending with no light
char array2[8] = {0x30, 0x20, 0x18, 0x10, 0x08, 0x38, 0x00, 0x28};  // hexadecimal array that contains the color values for D1 starting with cyan and ending with purple
void main(void)
{
